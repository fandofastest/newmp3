...
public class LocalFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        musicAdapter = new MusicOfflineAdapter(getContext(), PlayerService.listlocal);
        ...
        musicAdapter.setOnItemClickListener(new MusicOfflineAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int pos) {
                ...
                PlayerService.currentlistoffline= PlayerService.listlocal;
    ...
    public void getMusic(){
        ...
        Log.e("listloca", String.valueOf(PlayerService.listlocal.size()));
